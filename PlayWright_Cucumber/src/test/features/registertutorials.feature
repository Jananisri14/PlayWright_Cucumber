...
Scenario: Registration should be success
    And User enter the firstname as "marshell"
    And User enter the lastname as "joe"
    And User enter the email as "marshall123@gmail.com"
    And User enter the telephone as "8987676182"
    And User enter the password as "marshell@123"
    And User enter the cpassword as "marshell@123"
